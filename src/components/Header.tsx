...
export default function Header(): JSX.Element {
  ...
  const handleModFilterChange = (mod: string): void => {
    ...
    setSearchParams((prevParams) => {
      ...
      const newFilters = filters.modFilters.includes(mod) ? filters.modFilters.filter((id) => id !== mod) : [...filters.modFilters, mod];
      newParams["modFilters"] = newFilters.join(",");
...
//               Show All
//             </button>
//             <button type="button" onClick={() => handleFilterChange("type", "mod")} className={`mod-btn ${type === "mod" ? "selected" : ""}`}>
//               Mod Only
//             </button>
//             <button
//               type="button"
...
//               Ears
//             </button>
//             <button type="button" onClick={() => handleFilterChange("location", "nose")} className={`filter nose ${location === "nose" ? "selected" : ""}`}>
//               Nose
//             </button>
//             <button
//               type="button"
...
//               }}
//               disabled={location === "lips"}
//               className={`mod ${modFilters.includes("p4_blooming") && location !== "lips" ? "selected" : ""}`}
//             >
//               <input
//                 type="checkbox"
//                 name="p4_blooming"
//                 checked={modFilters.includes("p4_blooming") && location !== "lips"}
//                 disabled={location === "lips"}
//                 readOnly
//               />
